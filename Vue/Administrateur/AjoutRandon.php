        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4" center>
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <form action="../../Controller/ControlRandonnee.php"  method="post" enctype="multipart/form-data">    
                        <h6 class="mb-4">Ajouter Randonée</h6>
                            ...
                            <div class="form-floating mb-3">
                                <input name="objectif" type="text" class="form-control" placeholder="id" required>
                                <label >objectif</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input name="ville" type="text" class="form-control" placeholder="id" required>
                                <label >ville</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input name="description" type="text" class="form-control" placeholder="id" required>
                                <label >description</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input name="dateDeb" type="date" class="form-control" placeholder="id" required>
                                <label >dateDeb</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input name="dateFin" type="date"  class="form-control" placeholder="id" required>
                                <label >dateFin</label>
                            </div>
                       ...
                       ?>
                            ...
                            <div class="form-floating">
                                <textarea name="Commentaire" class="form-control" placeholder="Leave a comment here"
                                    id="floatingTextarea" style="height: 150px;" required></textarea>
                                <label>Commentaire</label>
                            </div>
                            <input type="file" name="img" required>

                            <input type="submit" class="btn btn-warning m-2" value="ajout randone">
                        </form>
                        </div>
                    </div>
