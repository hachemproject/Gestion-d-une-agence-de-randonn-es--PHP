...
<td><a href="AjoutRandon.php " class="btn btn-outline-success m-2">ajouter randnee</a></td>
...
echo "<tr>
        ...
        <th>Supprimer</th>
                     ...
                     echo "<tr>";
                     echo "<td>" . $ra->idRandonnee . "</td>";
                     echo "<td>" . $ra->description . "</td>";
                     echo "<td>" . $ra->objectif  . "</td>";
                     echo "<td>" . $ra->commentaire  . "</td>";
                     echo "<td><a href='ModifireRand.php?action=ControlModfiRand&id=" . $ra->idRandonnee . "' class='btn btn-primary'>Modifier</a></td>";
                    echo "<td><a href='../../Controller/ContolSuprimRandone.php?id=" . $ra->idRandonnee  . "' class='btn btn-danger' onclick=\"return confirm('Êtes-vous sûr de vouloir supprimer cet randonnée ?')\">Supprimer</a></td>";
