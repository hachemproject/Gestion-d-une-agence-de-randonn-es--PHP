    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <form action="UtilisateurByRand.php" method="get" class="d-none d-md-flex ms-4">
    <div class="d-none d-md-flex ms-4">
        <input name="SearchByRand" class="form-control bg-dark border-0" type="search" placeholder="Search By Randonée">
    </div>
    <button type="submit" class="btn btn-outline-success m-2">Chercher par randonnée</button>
</form>
...
<td><a href="AjoutRandon.php " class="btn btn-outline-success m-2">ajouter randnee</a></td>
     ...
     <?php
          ...
          $listRand=randonnee::AfficherRandonnee();
