...
?>
    <div class="container-fluid position-relative d-flex p-0">
     ...
     <?php
          ...
          $listRand=randonnee::AfficherEtatRand("2");
...
echo "<h6 class='mb-4'>Randonnées Finalisée</h6>";
...
echo "<tr>
        ...
        <th>Supprimer</th>
                ...
                foreach($listRand as $rand)
                {
                    ...
                    echo "<td><a href='Description.php?action=ContolModifRandon&id=" . $rand->__get('idRandonnee') . "' class='btn btn-primary'>Plus d'Info</a></td>";
                    echo "<td><a href='ModifireRand.php?action=ContolModifRandon&id=" . $rand->__get('idRandonnee') . "' class='btn btn-primary'>Modifier</a></td>";
