...
<!--aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa-->
         ...
         <?php
          $listUtilis=utilisateur::AfficherUtilisateur();
          ...
          <th>date_naiss</th><th>email</th><th>role</th></tr>";                    
                ...
                {
                     echo "<tr>";
                     echo "<td>" . $utili->__get('cin') . "</td>";
                     echo "<td><img width=100% height=10% src='../photos/" . $utili->__get('image') . "'></td>";
                     echo "<td>" . $utili->__get('password') . "</td>";
                     echo "<td>" . $utili->__get('nom') . "</td>";
                     echo "<td>" . $utili->__get('prenom') . "</td>";
                     echo "<td>" . $utili->__get('date_naiss') . "</td>";
                     echo "<td>" . $utili->__get('email') . "</td>";
                     if ($utili->__get('role') == 0) {
