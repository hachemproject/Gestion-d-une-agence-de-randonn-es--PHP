...
?>
                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Nombre de Randonneurs</p>
                                <h6 class="mb-0"><?php echo $nbUT; ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Nombre de Bus:</p>
                                <h6 class="mb-0"><?php echo $nbBus  ?></h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Nombre randonnée </p>
                                <h6 class="mb-0"><?php echo $nbRan  ?></h6>
                            </div>
                        </div>
                    </div>
          ...
          $listArt=randonneur::MeilleurUtilisateur();
          ...
          echo"         <h6 class='mb-0'>Meilleurs Utilisateurs</h6>";
          echo"     </div>";
          ...
          echo"                     <th scope='col'>date_naiss</th>";
          ...
          {
            $a = $Art['cin'];
            $ut = utilisateur::SelctCin($a);

            echo" <tbody>";
            echo "<tr>";
            echo "<td>" . $ut->cin. "</td>";
            echo "<td><img class='rounded-circle' width=80% height=80% src='../photos/" . $ut->image. "'></td>";
            echo "<td>" . $ut->password . "</td>";
            echo "<td>" . $ut->nom . "</td>";
           echo "<td>" . $ut->prenom. "</td>";
            echo "<td>" . $ut->date_naiss . "</td>";
            echo "<td>" . $ut->email. "</td>";
            if ($ut->role == 0) {
