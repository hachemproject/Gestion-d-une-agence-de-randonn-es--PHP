...
<!--aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa-->
         ...
         <?php
        $idRandonnee = $_GET['SearchByRand'];
        include("../../Model/randonneur.php");
        $listRandonneurs = randonneur::AfficherUtilisateurByRand($idRandonnee);
          ...
          echo"<tr><th>cin</th><th>image</th><th>password</th><th>nom</th><th>prenom</th>
          <th>date_naiss</th><th>email</th><th>role</th></tr>";                    
               

          foreach ($listRandonneurs as $randonneur) 
            {
                $cin = $randonneur->__get('cin');
                $listUtilisateurs = utilisateur::AfficherUtilisateurByCin($cin);
                foreach ($listUtilisateurs as $utilisateur) {
                     echo "<tr>";
                     echo "<td>" . $utilisateur->__get('cin'). "</td>";
                     echo "<td><img width=100% height=10%  src='../photos/" . $utilisateur->__get('image') . "'></td>";
                     echo "<td>" . $utilisateur->__get('password') . "</td>";
                     echo "<td>" . $utilisateur->__get('nom') . "</td>";
                     echo "<td>" . $utilisateur->__get('prenom') . "</td>";
                     echo "<td>" . $utilisateur->__get('date_naiss') . "</td>";
                     echo "<td>" . $utilisateur->__get('email') . "</td>";
                     if ($utilisateur->__get('role') == 0) {
                        echo "<td>simple utilisateur</td>";
                    } else {
